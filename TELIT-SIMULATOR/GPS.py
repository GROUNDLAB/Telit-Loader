...
gpsDilutionLock = [['5.4','2'], ['4.3','0'], ['1.5','0'], ['1.3','2'], ['2.9','0'], ['1.4','0'], ['3.0','0'], ['1.0','0'], ['5.5','0'], ['2.3','0'], ['2.3','0'], ['1.9','0'], ['2.0','0'], ['5.0','0'], ['2.9','0'], ['1.4','0'], ['3.0','0'], ['1.0','0'], ['5.5','0'], ['2.3','0'], ['2.3','0'], ['1.9','0'], ['2.0','0'], ['5.0','0']]
gpsIndex = 0
##########################################################################################
def getActualPosition():
	...
	head = '\r\n$GPSACP: '
	static = '053053.000,4223.5412N,07106.9411W,1.2,49.4,3,184.24,3.60,1.94,141108,06'
	tail ='\r\nOK\r\n'
